    ...
    <>
      {
        ...
        ? <div style={{ height: `${height}px`, width: `${width}px`}} className={`${isDragging ? "bg-green-500/40" : ""} relative !overflow-hidde z-[2] flex items-center justify-center `} onDragOver={handleReceiptDragOver} onDragEnter={handleReceiptDragEnter} onDragLeave={handleReceiptDragLeave} onDrop={handleReceiptDrop}>
          {
