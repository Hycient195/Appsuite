  ...
  if (isError) {
    return (
      <svg width="35" height="35" viewBox="0 0 25 25" fill="#343C54" xmlns="http://www.w3.org/2000/svg">
        ...
        <path fill-rule="evenodd" clip-rule="evenodd" d="M11.5625 16.8535C11.5625 13.885 13.969 11.4785 16.9375 11.4785C19.906 11.4785 22.3125 13.885 22.3125 16.8535C22.3125 19.822 19.906 22.2285 16.9375 22.2285C13.969 22.2285 11.5625 19.822 11.5625 16.8535ZM16.9375 12.9785C14.7974 12.9785 13.0625 14.7134 13.0625 16.8535C13.0625 18.9936 14.7974 20.7285 16.9375 20.7285C19.0776 20.7285 20.8125 18.9936 20.8125 16.8535C20.8125 14.7134 19.0776 12.9785 16.9375 12.9785Z" fill="rgb(220 38 38)"></path>
      </svg>
    );
  }
  ...
  if (isSuccess && !isLoading && !showDefaultIcon) {
    return (
      <svg width="35" height="35" viewBox="0 0 25 25" fill="#343C54" xmlns="http://www.w3.org/2000/svg" className="animate-fade-in">
        ...
        <path fill-rule="evenodd" clip-rule="evenodd" d="M11.5625 16.8535C11.5625 13.885 13.969 11.4785 16.9375 11.4785C19.906 11.4785 22.3125 13.885 22.3125 16.8535C22.3125 19.822 19.906 22.2285 16.9375 22.2285C13.969 22.2285 11.5625 19.822 11.5625 16.8535ZM16.9375 12.9785C14.7974 12.9785 13.0625 14.7134 13.0625 16.8535C13.0625 18.9936 14.7974 20.7285 16.9375 20.7285C19.0776 20.7285 20.8125 18.9936 20.8125 16.8535C20.8125 14.7134 19.0776 12.9785 16.9375 12.9785Z" fill="rgb(22 190 74)"></path>
      </svg>
    );
  }
