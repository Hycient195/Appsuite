...
export const StatusIcon: React.FC<StatusIconProps> = ({ isLoading, isSuccess, isError }) => {
  ...
  if (isSuccess && !isLoading && !showDefaultIcon) {
    return (
      <div className=" animate-fade-in" style={{ width: 20, height: 20 }}>
        <svg width="24" height="24" viewBox="0 0 20 20" fill="green">
          <polyline points="4 10 8 14 16 6" stroke="green" strokeWidth="2" fill="none" />
        </svg>
      </div>
    );
  }
