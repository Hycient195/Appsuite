...
export default function CreateBalanceSheet() {
  ...
  const handleCreateFile = async () => {
    ...
    createFile({ appName: "INVOICE_MANAGER", fileName: `${fileName}.json`, content: JSON.stringify(defaultGlobalInvoice), mimeType: "application/json"});
  };
  ...
  return (
    <main className="h-full">
      <div className="bg-whit border border-zinc-200 rounded-md min-h-full flex ">
