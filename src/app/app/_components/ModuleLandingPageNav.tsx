...
export default function ModuleLandingPageNav({ className }: IProps) {
  ...
  return (
    ...
    >
      ...
      className="flex max-w-screen-md mx-auto gap-10 justify-between items-center overflow-hidden px-12 w-full text-base text-blue-100 whitespace-nowrap bg-primary max-md:min-h-[55px] md:min-h-[64px] rounded-[33px] max-md:px-5 max-md:max-w-full">
